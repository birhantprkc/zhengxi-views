...
### 语料与方法
- 新增郑希于 2026-08-31 发布的《2026年中期报告》原文，语料覆盖更新至 2026 年中报。
- 在投资方法中补充“根据行业景气程度预判调整行业集中度”的最新原话佐证。

### 基金数据
- 刷新郑希 4 只在任基金的数据快照至 2026-09-03 净值口径。
- 新增 4 只在任基金的 2026 年第 2 季度前十大重仓股、2026-06-30 规模与资产配置数据。
- 重建语料索引与基金数据索引。
- 按仓库 `.gitattributes` 规范统一 `corpus_index.json` 的 LF 换行，避免 Windows 克隆后被误判为修改。
